...
z = [x;v];
%% Initial Conditions
assert(numPar.x0<(par.H-par.xbar), "Water is overflowing the bubble trap") %check that water cannot overflow
...
op=odeset('RelTol',1e-10,'AbsTol',1e-12,'InitialStep',1e-9,'Refine',3);
%%Solving EOM
